...
@pytest.mark.parametrize('utime', [time_0d, time_1d])
@pytest.mark.parametrize('glat,glon,galt', [(glat_nan_0d,glon_nan_0d,galt_nan_0d), (glat_nan_1d,glon_nan_1d,galt_nan_1d), (glat_nan_2d,glon_nan_2d,galt_nan_2d), (glat_nan_3d,glon_nan_3d,galt_nan_3d)])
