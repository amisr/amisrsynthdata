...
# Store everything in geodetic coordinates?
...
class Radar(object):
    ...
    def __init__(self, config):
        ...
        self.site_lat = self.site_coords[0]
        self.site_lon = self.site_coords[1]
        self.site_alt = self.site_coords[2]
    ...
    def kvec_all_gates(self):
        ...
        print(self.lat.shape, kvec.shape)
        ...
        # self.X0, self.Y0, self.Z0 = pm.geodetic2ecef(self.site_lat, self.site_lon, self.site_alt)
