...
print(ne.shape, te.shape, ti.shape)
...
with h5py.File(radar.output_filename, mode='w') as h5:
    ...
    h5.create_dataset('/FittedParams/Range', data=range0)
    ...
    h5.create_dataset('/NeFromPower/Range', data=range0_nb)
...
ax.scatter(radar.x, radar.y, radar.z, c=ne, vmin=0., vmax=4e11)

ax = fig.add_subplot(gs[-1,1], projection='3d')
ax.scatter(radar.x, radar.y, radar.z, c=Vlos, vmin=-500., vmax=500.)

ax = fig.add_subplot(gs[-1,2], projection='3d')
ax.scatter(radar.x, radar.y, radar.z, c=te, vmin=0., vmax=5e3)

ax = fig.add_subplot(gs[-1,3], projection='3d')
ax.scatter(radar.x, radar.y, radar.z, c=ti, vmin=0., vmax=3e3)
